...
var houseAulaScene = new Phaser.Class({
  ...
  create: function () {
    ...
    const platforms = houseaulamap.createStaticLayer('Ground', tiles, 0, 0);
    const obstacles = houseaulamap.createStaticLayer('Obstacles', tiles, 0, 0);
    //const obstacles2 = map.createStaticLayer('Obstacles2', tiles, 0, 0);
    ...
    // our player sprite created through the physics system
    this.player = new Player(this, 60, 60, 'player', 18, 100, 20, 'Alice');
    //this.player.scale(2);
    console.log(this.player);
    this.add.existing(this.player);
